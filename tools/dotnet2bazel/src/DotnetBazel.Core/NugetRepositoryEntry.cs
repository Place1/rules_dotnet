...
namespace DotnetBazel.Core
{
    public interface INugetRepositoryEntry
    {
        ...
        List<string> TargetingPackOverrides { get; }
        string Hash { get; }
    }
    ...
    public class NugetRepositoryEntry : INugetRepositoryEntry
    {
        public NugetRepositoryEntry(LocalPackageSourceInfo localPackageSourceInfo,
          ...
          List<string> targatingPackOverrides = null)
        {
            ...
            TargetingPackOverrides = targatingPackOverrides ?? new List<string>();
        }
        ...
        public List<string> TargetingPackOverrides { get; }
